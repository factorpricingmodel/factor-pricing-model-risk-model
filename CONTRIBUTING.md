...
Factor Pricing Model Risk Model could always use more documentation, whether as part of the official Factor Pricing Model Risk Model docs, in docstrings, or even on the web in blog posts, articles, and such.
...
2. Clone your fork locally:
   ...
   ```shell
   $ git clone git@github.com:your_name_here/factor-pricing-model-risk-model.git
   ```
...
2. Update the version in both the setup file `pyproject.toml` and package
   file `src/fpm_risk-model/__init__.py`
...
[gh-issues]: https://github.com/factorpricingmodel/factor-pricing-model-risk-model/issues
